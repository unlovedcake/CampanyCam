...
class GalleryBottomNav extends StatefulWidget {
  const GalleryBottomNav({Key? key}) : super(key: key);

  @override
  _GalleryBottomNavState createState() => _GalleryBottomNavState();
}

class _GalleryBottomNavState extends State<GalleryBottomNav>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Container(
          margin: const EdgeInsets.only(left: 4, top: 40, bottom: 4),
